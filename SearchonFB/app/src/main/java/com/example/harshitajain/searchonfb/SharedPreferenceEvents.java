...
public class SharedPreferenceEvents implements FavsInterface {

        public static final String PREFS_NAME = "User_obj_APP";
        public static final String FAVORITES = "User_obj_Favorite1_events";


        public SharedPreferenceEvents() {
            super();
        }
